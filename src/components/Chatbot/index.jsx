...
const API_KEY = "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";

const systemMessage = {
  role: "system",
  content:
    "Translate my messages to Spanish as though I am learning French, provide the English too.",
};
